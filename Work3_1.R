...
### Omit will remove all data with NA in any position
  ...
  stop("The value is accept. Please try again")
}}}
  ...
  cat('Mean: ', mean(select_penguin$bill_length_mm), '\n')
  var1 <- Mode(select_penguin$bill_length_mm)
  cat('Mode: ', var1, '\n')
  cat('SD: ', sd(select_penguin$bill_length_mm), '\n')
  ...
  cat('Mean: ', mean(select_penguin$bill_depth_mm), '\n')
  var1 <- Mode(select_penguin$bill_depth_mm)
  cat('Mode: ', var1, '\n')
  cat('SD: ', sd(select_penguin$bill_depth_mm), '\n')
  ...
  cat('Mean: ', mean(select_penguin$flipper_length_mm), '\n')
  var1 <- Mode(select_penguin$flipper_length_mm)
  cat('Mode: ', var1, '\n')
  cat('SD: ', sd(select_penguin$flipper_length_mm), '\n')
  ...
  cat('Mean: ', mean(select_penguin$body_mass_g), '\n')
  var1 <- Mode(select_penguin$body_mass_g)
  cat('Mode: ', var1, '\n')
  cat('SD: ', sd(select_penguin$body_mass_g), '\n')
